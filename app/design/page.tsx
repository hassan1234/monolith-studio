...
const journey = [
  {
    ...
    p: "We map out your spatial flow, structural possibilities, and functional layouts. Every square foot is optimized for the way you live.",
  },
  {
    n: "02",
    h: "Curation & Mood Boards",
    img: "/images/journey-moodboard.jpg",
    ...
    <main>
      <header className="page-hero">
        <div className="page-hero__img" aria-hidden="true">
          <Image src="/images/design-hero.jpg" alt="" fill priority sizes="100vw" />
        </div>
      ...
      <section className="capabilities" style={{ paddingTop: 0 }}>
        <div className="wrap">
          ...
          <div className="svc-more">
            {servicesByDiscipline("design").map((s) => (
