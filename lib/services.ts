...
export type Service = {
  ...
  /** Optional numbered process section, rendered only when present. */
  stages?: { n: string; h: string; p: string }[];
  /** Heading for the stages section; falls back to a generic one. */
  stagesTitle?: string;
...
export const services: Service[] = [
  ...
  },
  {
    ...
    body: [
      ...
      "A ground-up build is the one project where design and construction genuinely cannot be separated. Structure, utilities and finishes all have to be resolved together — moving a wall is also a change to a beam, a lighting circuit and a tile layout. Because the same team holds all three, those decisions get made once, in the right order, instead of being renegotiated on site months later.",
      "We start with the site. What the plot allows, how the house wants to sit on it, where the light comes from, and what is realistic to build for the budget you have in mind. Only once that is honest do we start drawing.",
      "Because the same team carries the project from concept through to the final finish, the detailing that usually gets lost between architect, contractor and finisher stays intact. You get one point of contact for the whole build, an itemized proposal before work starts, and a schedule that tracks against real milestones — foundations, weathertight, rough-in, finishes — rather than one distant completion date.",
    ],
    included: ["Site feasibility and budgeting", "Design, layout and 3D renderings", "Foundations, framing and envelope", "Plumbing, electrical and HVAC", "Cabinetry, millwork and built-ins", "Hand-applied surface finishes"],
    stagesTitle: "From empty site to finished house.",
    stages: [
      { n: "01", h: "Feasibility", p: "We look at the site, what the plot and envelope allow, and what is realistic to build for your budget — before anything is drawn." },
      { n: "02", h: "Design", p: "Plans, elevations and material selections worked up with you, then rendered in 3D so you can walk through the house long before it exists." },
      { n: "03", h: "Approvals", p: "Drawings are developed to the level the permit set requires, and the submissions and inspections the build depends on are coordinated for you." },
      { n: "04", h: "Structure", p: "Foundations, framing, roof and envelope — the house made weathertight before anything goes inside it." },
      { n: "05", h: "Fit-out", p: "Utilities roughed in first, then cabinetry, millwork, tiling and built-ins, all set out to the drawing rather than improvised on site." },
      { n: "06", h: "Finish", p: "Hand-applied surfaces, lighting, hardware, a final punch list and a clean handoff." },
    ],
