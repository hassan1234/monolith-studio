...
export const services: Service[] = [
  ...
  },
  {
    ...
    body: [
      "Building new means every decision is yours from the first line — how the plan works, where the light lands, how the rooms connect.",
      "Structure, utilities and finishes get resolved together, by one team. Move a wall and you move a beam, a circuit and a tile layout, so the call gets made once.",
      "We start with the site and a realistic budget. Only then do we draw.",
    ],
    ...
    stages: [
      { n: "01", h: "Feasibility", p: "What the plot allows, and what is realistic for your budget — before anything is drawn." },
      ...
      { n: "03", h: "Approvals", p: "Drawings developed to permit-set level, with submissions and inspections coordinated for you." },
      { n: "04", h: "Structure", p: "Foundations, framing, roof and envelope — the house made weathertight before anything goes inside it." },
      { n: "05", h: "Fit-out", p: "Utilities roughed in first, then cabinetry, millwork, tiling and built-ins — all set out to the drawing." },
